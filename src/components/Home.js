        ...
        <Row xs={1} md={2} className="h-100">
          <Col className="my-auto">
            <div>
              ...
              <h1 className="color-name-blue text-boldest">I'm Taha</h1>
              <span className="color-custom-grey h4">
                ...
                >
                  ...
                  <span className="font-weight-bold">
                    <span className="font-weight-bold">IT Professional</span>
                    <Typist.Backspace count={15} delay={3500} />
                    <span className="font-weight-bold">
                      Frontend{" "}
                      <span className="font-weight-normal">Developer </span>
                    </span>
                    <Typist.Backspace count={19} delay={3500} />
                    System Analyst <Typist.Backspace count={15} delay={3500} />
                    Network Engineer
                  </span>
                </Typist>
              </span>
              ...
              <span className="color-custom-grey h5">
                Experienced in Frontend Development (React.js), ERP Systems,
                Network Engineering, and Data Management
              </span>
              <br />
            </div>
            <div className="d-flex my-4">
              <Button
                ...
                aria-label="github"
                onClick={() =>
                  window.open("https://github.com/beingtaha", "_blank")
                }
              >
                <FontAwesomeIcon spin size="2x" icon={faGithubSquare} />
              </Button>
              <Button
                variant=""
                className="color-custom-blue p-0 mr-3 border-0"
              ...
              >
                <FontAwesomeIcon spin size="2x" icon={faLinkedin} />
              </Button>
            </div>
            <Button
