          ...
          <Col className="float-md-right text-right">
            ...
            <div className="mt-3 mb-3 pr-lg-5 pr-xs-3">
              <Button className="contact-btns bg-custom-blue mr-2 shadow border-0 py-1">
                ...
                <span>
                  <a href="tel:+919895051128" className="text-link">
                    Phone
                  </a>
                </span>
              </Button>
              <Button
                className="contact-btns bg-custom-blue mr-2 shadow border-0 py-1 px-2"
                onClick={() =>
                  window.open(
                    'mailto:tahaahmed434@gmail.com?subject="Hello !"',
                    "_blank",
                  )
                }
              >
