    ...
    technicalSkills: [
      ...
      },
      {
        ...
        skills: [
          ...
          { name: "Cross-platform App Development", level: 80, icon: "🔄" },
        ],
      },
      {
        category: "AI-Augmented Development",
        skills: [
          { name: "Prompt-driven Development", level: 85, icon: "🤖" },
          { name: "Claude / Antigravity Workflows", level: 85, icon: "✨" },
          { name: "Rapid Prototyping", level: 80, icon: "🚀" },
        ],
      },
      {
