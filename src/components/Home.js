          ...
          <Col className="my-auto">
            <div>
              ...
              <span className="color-custom-grey h4">
                ...
                >
                  ...
                  <span className="font-weight-bold">
                    ...
                    <Typist.Backspace count={21} delay={3500} />
                    <span className="font-weight-bold">
              ...
              <span className="color-custom-grey h5">
                Building web and mobile apps with React.js, React Native, and
                Flutter — using AI coding agents to deliver faster, without
